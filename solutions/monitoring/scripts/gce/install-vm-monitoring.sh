...
gcloud storage cp gs://${CERT_BUCKET}/vm-certs/tls.crt /etc/otel/certs/tls.crt
gcloud storage cp gs://${CERT_BUCKET}/vm-certs/tls.key /etc/otel/certs/tls.key

chown -R otelcol-contrib:otelcol-contrib /etc/otel/certs
chmod 600 /etc/otel/certs/tls.key
chmod 644 /etc/otel/certs/tls.crt /etc/otel/certs/ca.crt
